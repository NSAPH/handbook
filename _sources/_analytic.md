...
`````{dropdown} 16. Denominator File Clean 2000-2016 Merged with Exposure and Covariate Data 
```{list-table}
:header-rows: 0
* - dataset_author
  - Mahdieh Danesh Yazdi
...
`````{dropdown} 17. Hospital Admissions Data Merged with Denominator File, Exposure, and Covariates 2000-2016
```{list-table}
:header-rows: 0
* - dataset_author
  - Mahdieh Danesh Yazdi
