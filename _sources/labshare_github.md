# Lab Share and GitHub Project Work

If you are working in a team on a project which uses GitHub, you might encounter some issues while using Lab Share. If you and your teammates are both working from a folder in Lab Share and connecting to GitHub through this folder, your work may suddenly start to disappear and be overwritten, even if you and your teammates are working on the project at different times. 
...
- Each teammate should have their own project folder in Lab Share which is connected to one GitHub repository
- Use symbolic links to data sources
- It is a good idea to use different GitHub branches
- At the end of the project, collapse down to one folder in Lab Share
